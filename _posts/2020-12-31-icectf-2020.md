...
and that's it! Bit of a shorter write up, but I thought I'd share my solution which I think will come in handy for future challenges. I'm sure there are many other applications of this too (such as cracking the passcodes of actual devices which use digit combination passcodes and have no retry limit), so that's something I'll be looking into a little more too. 
